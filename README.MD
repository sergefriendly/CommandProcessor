...
cmd    — сама функция;
-1     — способ разбияния строки для отделения аргументов.
В зависимости от способа на выходе получается разная интерпретация:
* Если = 1, то ```"cmd arg1 arg2 arg3 arg4" → ["cmd", "arg1 arg2 arg3 arg4"]```
* Если = 2, то ```"cmd arg1 arg2 arg3 arg4" → ["cmd", "arg1", "arg2 arg3 arg4"]```
* Если = 3, то ```"cmd arg1 arg2 arg3 arg4" → ["cmd", "arg1", "arg2", "arg3 arg4"]```
* И т.д.
* Если = 0, то ```"cmd arg1 arg2 arg3 arg4" → ["cmd arg1 arg2 arg3 arg4"]```
* Если = -1, то ```"cmd arg1 arg2 arg3 arg4" → ["cmd", "arg1", "arg2", "arg3", "arg4"]```
